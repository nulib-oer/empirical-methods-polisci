...
```{r fig2-1, fig.align='center', fig.cap='Our theory: X causes Y'}
...
```{r fig2-2, fig.align='center', fig.cap='Reverse causality: Y causes X'}
...
```{r fig2-3, fig.align='center', fig.cap='Omitted Variable: actually, age explains both X and Y!'}
