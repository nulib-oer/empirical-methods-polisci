...
```{r population_sample, fig.align='center', fig.cap='Population and Sample'}
...
```{r Virginia_sampling, fig.align='center', fig.cap='How Sampling Can Go Wrong'}
...
```{r stratified-random-sampling, fig.align='center', fig.cap='Stratified Random Sampling. Note: The population is grouped into strata based on shared characteristics'}
knitr::include_graphics('images/surveys/Virginia_sampling.png', dpi = NA)
```
...
```{r Cluster-sampling, fig.align='center', fig.cap='Cluster Sampling. Note: Here, the population is divided into several clusters; note that the entire cluster is sampled'}
...
```{r Marginoferror, fig.align='center', fig.cap='Margin of Error and Confidence Interval'}
...
```{r Confidence_interval, fig.align='center', fig.cap='Confidence Interval in a Poll'}
...
```{r coverage_error, fig.align='center', fig.cap='Coverage Error'}
