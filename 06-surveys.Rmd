...
```{r population_sample, fig.align='center', fig.cap='Population and Sample', echo=FALSE}
knitr::include_graphics('images/surveys/population_sample.png', dpi = NA)
```
...
```{r Virginia_sampling, fig.align='center', fig.cap='How Sampling Can Go Wrong', echo=FALSE}
knitr::include_graphics('images/surveys/Virginia_sampling.png', dpi = NA)
```
...
```{r stratified-random-sampling, fig.align='center', fig.cap='Stratified Random Sampling. Note: The population is grouped into strata based on shared characteristics', echo=FALSE}
knitr::include_graphics('images/surveys/Virginia_sampling.png', dpi = NA)
```
...
```{r Cluster-sampling, fig.align='center', fig.cap='Cluster Sampling. Note: Here, the population is divided into several clusters; note that the entire cluster is sampled', echo=FALSE}
knitr::include_graphics('images/surveys/Cluster-sampling.png', dpi = NA)
```
...
```{r Marginoferror, fig.align='center', fig.cap='Margin of Error and Confidence Interval', echo=FALSE}
knitr::include_graphics('images/surveys/Marginoferror.png', dpi = NA)
```
...
```{r Confidence_interval, fig.align='center', fig.cap='Confidence Interval in a Poll', echo=FALSE}
knitr::include_graphics('images/surveys/Confidence_interval.png', dpi = NA)
```
