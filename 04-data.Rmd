...
```{r samples, fig.align='center', fig.cap='Stratified vs. Clustered sampling'}
...
```{r target, fig.align='center', fig.cap='Validity and reliability'}
...
```{r plots, fig.align='center', fig.cap='Types of distributions'}
