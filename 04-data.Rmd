...
```{r samples, fig.align='center', fig.cap='Stratified vs. Clustered sampling', echo=FALSE}
knitr::include_graphics('images/data/samples.png', dpi = NA)
```
...
```{r target, fig.align='center', fig.cap='Validity and reliability', echo=FALSE}
knitr::include_graphics('images/data/target.png', dpi = NA)
```
...
```{r plots, fig.align='center', fig.cap='Types of distributions', echo=FALSE}
knitr::include_graphics('images/data/plots.png')
```
