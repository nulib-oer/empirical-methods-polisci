...
```{r fig11-3, fig.align='center', fig.cap='A directed network of adviser--student relationships between political scientists', echo=FALSE}
...
```{r fig11-4, fig.align='center', fig.cap='Sociograms for undirected (left) and directed (right) graphs with highlighted geodesics between Kiko and Mega', echo=FALSE}
...
```{r fig11-7, fig.align='center', fig.cap='Betweenness (left) and closeness (right) for the undirected friendship network. Note that Parveen has the highest value for each measure', echo=FALSE}
...
```{r fig11-8, fig.align='center', fig.cap='Degree as measured in undirected (left) and directed (indegree, center; and outdegree, right) networks', echo=FALSE}
...
```{r fig11-9, fig.align='center', fig.cap='A histogram of the degree distribution for the undirected friendship network shows that there are two nodes with degree $1$, four with degree $2$, and one each with degrees $3$, $4$, or $5$', echo=FALSE}
...
```{r fig11-10, fig.align='center', fig.cap='Local transitivity for the undirected friendship network (with global transitivity = $0.3913$ and average local transitivity = $0.5407$)', echo=FALSE}
...
```{r fig11-11, fig.align='center', fig.cap='A geographic network with $k = 4$. Each node is connected to its four closest neighbors', echo=FALSE}
...
```{r fig11-12, fig.align='center', fig.cap='A random network with N = 15 and p = 0:2', echo=FALSE}
...
```{r fig11-13, fig.align='center', fig.cap='Sociograms of a single small-world network with N = 17 nodes. This graph has a diameter of 4, mean degree centrality of 3:1 and a global clustering coefficient of 0:155', echo=FALSE}
...
```{r fig11-14, fig.align='center', fig.cap='A sociogram and histogram of the corresponding degree distribution for a power-law network', echo=FALSE}
...
```{r fig11-15, fig.align='center', fig.cap='Sociograms for Questions 2 (left) and 3 (right)', echo=FALSE}
...
```{r fig11-16, fig.align='center', fig.cap='Highlighted geodesic between 1 and 7', echo=FALSE}
